---
title: "SNPs in chr13:32889968G>A and 32890026C>T"
output:
  html_document:
    df_print: paged
...
```
## Determine colliding reads and genotype combinations
```{r}
SNP1=32889968
SNP2=32890026
...
barplot(table(collisions[,11]),main="Boundary supported Haplotypes", sub = names(Collisions_input[x]))
}
```
